...
const Contacto = () => {
  ...
  <div className="gmap-area mt-8">
    <div className="container">
      <div className="flex flex-wrap justify-center">
        {/* Mapa */}
        <div className="w-full sm:w-1/2 text-center relative">
          <div className="gmap rounded-full overflow-hidden w-64 h-64 mx-auto border-4 border-white shadow-lg">
            <iframe
        ...
        <div className="w-full sm:w-1/2 mt-8 sm:mt-0 text-center sm:text-left">
